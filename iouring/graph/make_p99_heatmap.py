...
def main():
    ...
    output_file = script_dir / f"heatmap/{input_file.stem}_heatmap_with_notsx.png"
    ...
    ax.set_xlabel("time Slice extension 拡張時間 (us)")
    ax.set_ylabel("競合プロセス数")
    # ax.set_title("io_uring 実装における競合プロセス数と拡張時間による RTT の p99 ヒートマップ")
